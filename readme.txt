...
Donate link: https://catchthemes.com/wp-plugins/catch-web-tools/
...
Catch Themes team does not provide support for the Catch Web Tools plugin on the WordPress.org forums. Support is provided at [Catch Web Tools Support Forum](https://catchthemes.com/support-forum/forum/catch-web-tools/)
...
= 1.9.2 =
* Bug Fixed: Display on hover without scrolling issue [To Top Module]
