...
function catchwebtools_custom_seo_fields_save_meta( $post_id ) {
	...
	$og_title = wp_filter_post_kses( $_POST['catchwebtools_opengraph_title'] );
    ...
    $og_description = wp_filter_post_kses( $_POST['catchwebtools_opengraph_description'] );
    ...
    $og_type = wp_filter_post_kses( $_POST['catchwebtools_opengraph_type'] );
	...
	$og_custom = wp_filter_post_kses( $_POST['catchwebtools_opengraph_custom'] );
    ...
    $seo_title = wp_filter_post_kses( $_POST['catchwebtools_seo_title'] );
	...
	$seo_description = wp_filter_post_kses( $_POST['catchwebtools_seo_description'] );
	...
	$seo_keywords = wp_filter_post_kses( $_POST['catchwebtools_seo_keywords'] );
