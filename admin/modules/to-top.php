    ...
    <div id="to_top_main">
        <form method="post" action="options.php">
            ...
            <div class="option-container">
                ...
                <div class="catchwebtools_to_top_options_icon_settings">
                ...
                <div class="catchwebtools_to_top_options_image_settings">
                    ...
                    <table class="form-table">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input class="upload-url" size="65" type="text" name="catchwebtools_to_top_options[image]" value="<?php echo esc_url( $settings['image'] ); ?>" />
                ...
                <h3 class="option-toggle option-active"><a href="#"><?php esc_html_e( 'Advanced Settings', 'catch-web-tools' ); ?></a></h3>
                ...
                <h3 class="option-toggle option-active"><a href="#"><?php esc_html_e( 'Reset Settings', 'catch-web-tools' ); ?></a></h3>
                <div class="option-content inside">
                    <table class="form-table">
                        <tbody>
                            <tr>
